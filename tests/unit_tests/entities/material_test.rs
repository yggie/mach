...
fn it_can_be_instantiated_with_constant_density() {
    ...
    assert_eq!(material.density_of(&Cube::new_cube(2.0)), 1.5);
    assert_eq!(material.density_of(&Cube::new_cube(3.0)), 1.5);
    assert_eq!(material.density_of(&Cube::new_cube(4.0)), 1.5);
}
...
fn it_can_be_instantiated_with_constant_mass() {
    ...
    assert_eq!(material.mass_of(&Cube::new_cube(2.0)), 2.5);
    assert_eq!(material.mass_of(&Cube::new_cube(3.0)), 2.5);
    assert_eq!(material.mass_of(&Cube::new_cube(4.0)), 2.5);
}

#[test]
fn it_computes_the_mass_correctly_with_constant_density() {
    let cuboid = Cube::new(1.0, 2.0, 3.0);
